...
|----|---------|------|---------|------|
| DONE-037 | **🤖 DM Automation LIVE** — Claude AI + ManyChat + Lead scoring + English default + Fix double message + Shorter responses | 26/12/2024 | v2.28.3 | [→](./docs/sessions/2024-12-26-dm-automation.md) |
