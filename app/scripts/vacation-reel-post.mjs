...
const VACATION_THEMES = {
  ski: {
    ...
    captions: [
      ...
      'Ski all day, spa all night ⛷️✨',
      'Missing this view already 🏔️',
      'Throwback to this cozy moment 🔥',
    ],
  },
  ...
  beach: {
    ...
    captions: [
      ...
      'Island state of mind 🏝️',
      'Sunsets like this >>> everything 🌅',
      'Paradise found 🌺',
      'Salt in my hair, sand on my feet 🌊',
    ],
  },
